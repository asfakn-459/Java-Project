...
public class Author extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int maxphoneLength = 10; // Adjust this according to your database column length
    if (phone.length() > maxphoneLength) {
        JOptionPane.showMessageDialog(this, "Phone number is too long. Maximum length is " + maxphoneLength + " characters.");
        ...
        try {
            ...
            pst.setString(2, address);
              int maxPhoneLength = 10; // Adjust this according to your database column length
    if (phone.length() > maxPhoneLength) {
        phone = phone.substring(0,maxPhoneLength); // Exit the method without attempting to insert into the database
    }
            ...
            {
                JOptionPane.showMessageDialog(this, "Author Not Created");
            }
        } catch (SQLException ex) {
            Logger.getLogger(Author.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            {
                JOptionPane.showMessageDialog(this, "Author Not Updated");
            }
        } catch (SQLException ex) {
            Logger.getLogger(Author.class.getName()).log(Level.SEVERE, null, ex);
        }
